...
The [Automated npm version](https://github.com/freelensapp/freelens/blob/main/.github/workflows/npm-version.yaml) workflow
prepares a new PR for semantic versioning. After the PR is merged, the
[Release](https://github.com/freelensapp/freelens/blob/main/.github/workflows/release.yaml) workflow handles the release
process:
